...
syn  keyword gcFunction ENABLE METRIC SECONDS VELOCITY PSOCONTROL PSOOUTPUT CONTROL PSOCONTROL ABSOLUTE INCREMENTAL LINEAR DWELL DVAR
syn keyword gcIter FOR NEXT TO
...
syntax match gcRotationParam "\<[PQR]\>"
syntax match gcRotationParam "\<[PQR]-\?\d\+\>"
syntax match gcRotationParam "\<[PQR]-\?\.\d\+\>"
syntax match gcRotationParam "\<[PQR]-\?\d\+\."
syntax match gcRotationParam "\<[PQR]-\?\d\+\.\d\+\>"
...
hi def link ncFeed gcodeCommand
