...
syntax keyword gcIter DFS ELSE ELSEIF END ENDDFS ENDIF ENDRPT ENDW FARGOTO FARJUMP FOR GOTO IF JUMP NEXT PROGRAM REPEAT RPT THEN TO WHILE

syntax keyword gcStatus INPOS MODE NOWAIT OFF ON RESET WAIT
